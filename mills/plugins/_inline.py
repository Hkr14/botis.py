...
SUP_BUTTONS = [
    [
        Button.url("• Github •", url="https://github.com/Sarcehkr"),
        Button.url("• Support •", url="t.me/Sarcehkr"),
    ],
    [
...
HELP_BUTTONS = [
    [
        Button.url("• Owner •", url="https://t.me/Sarcehkr"),
        Button.url("• Support •", url="https://t.me/Sarcehkr"),
    ],
]
        ...
        result = await event.builder.article(
            ...
            buttons=[
                [
                    ...
                    Button.url("Channel", url="t.me/Sarcehkr"),
                ],
            ],
        )
        await event.answer([result])
    ...
    if len(text) < 6:
        result = await m.builder.article(
            ...
            buttons=[
                [
                    Button.url(client.name, url="t.me/{}".format(client.botname)),
                    Button.url("Channel", url="t.me/MarvipGroup"),
                ],
            ],
        )
    ...
    if not bin_info:
        result = await m.builder.article(
            ...
            buttons=[
                [
                    Button.url(client.name, url="t.me/{}".format(client.botname)),
                    Button.url("Channel", url="t.me/MarGroupVip"),
                ],
            ],
            thumb=InputWebDocument(BOT_PIC, 0, "image/jpg", []),
            content=InputWebDocument(BOT_PIC, 0, "image/jpg", []),
