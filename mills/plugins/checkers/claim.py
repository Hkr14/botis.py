...
async def _(m):
    ...
    if not params or not ( params.startswith('MarchkBot--') and params.endswith('-PREMIUM') ):
    ...
    if user['type'] == 'P' and params.startswith('MarchkBot-') and params.endswith('-PREMIUM'):
